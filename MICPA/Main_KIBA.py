...
class Transformer(nn.Module):
    ...
    def forward(self, input_Drugs, input_Tars, drug, smiles,protein):
        ...
        compound_attention_feature= COMPOUND_MCAT_KIBA(drug, len(drug),smiles).cuda()
...
if __name__ == '__main__':
    ...
    valDV_num=300
    fpath_davis = ''
    drug, target, affinity = DH.LoadData(fpath_davis, logspance_trans=False)
    ...
    smiles_Val = smiles[98545:118254]
    proteins_Val = proteins[98545:118254]
